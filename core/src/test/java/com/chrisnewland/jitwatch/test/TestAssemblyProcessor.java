...
public class TestAssemblyProcessor
{
	...
	private static final String[] JDK8_SINGLE_ASSEMBLY_METHOD = new String[] {
			...
			"[Constants]",
			"  # {method} &apos;dummyMethod&apos; &apos;()V&apos; in &apos;com/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
	...
	public void testARM7Assembly() throws ClassNotFoundException
	{
		String[] lines = new String[] {
				...
				"[Entry Point]",
				"[Constants]",
				"  # {method} &apos;add&apos; &apos;(II)I&apos; in &apos;com/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
				"  # this:     rsi:rsi   = &apos;com/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
				"  # parm0:    rdx       = int",
				"  # parm1:    rcx       = int",
	...
	public void testSingleAsmMethodInterrupted() throws ClassNotFoundException
	{
		String[] lines = new String[] {
				...
				"<jvms bci='31' method='com/chrisnewland/jitwatch/test/TestAssemblyProcessor dummyMethod2 ([Ljava/lang/String;)V' bytes='57' count='10000' backedge_count='6024' iicount='1'/>",
				"</uncommon_trap>",
				"<writer thread='140176736904960'/>",
				"/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
				"  # this:     rsi:rsi   = &apos;com/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
				"  # parm0:    rdx       = int",
				"  # parm1:    rcx       = int",
	...
	public void testJMHPerfAnnotations() throws ClassNotFoundException
	{
		String[] lines = new String[] {
				...
				"                 )I&apos; in &apos;com/chrisnewland/jitwatch/test/TestAssemblyProcessor&apos;",
